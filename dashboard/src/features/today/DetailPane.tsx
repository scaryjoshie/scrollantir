...
import { DonutPanel } from '@/components/Donut';
...
// SVG arc helpers + DonutChart / Legend / DonutPanel were extracted to
// @/components/Donut so /summary and /trends can reuse them. Same arc
// math, same legend layout, same active-key dimming.
...
// DonutPanel / DonutChart / Legend live in @/components/Donut so /summary
// and /trends share the same arc math, palette resolution, and dimming
// semantics. Importing here keeps /today's drill UI on a single source
// of truth.
