...
| [dashboard.md](dashboard.md) | **Planned module**, web-first rewrite after SwiftUI attempt (`macos/`) was parked 2026-04-21. Three stacked timelines (phone, mac, location), narrative-style location track, parsed/derived tables (`place_visits`, `travel_legs`). Has a fresh-agent handoff block at the end. |
