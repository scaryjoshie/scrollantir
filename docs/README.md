...
| [sessions/handoff-derived-dashboard.md](sessions/handoff-derived-dashboard.md) | **Current entry point for a fresh agent picking up the next phase.** Onboarding for derived views + dashboard timeline work: dependency chain (agent_api → views → derivers → pages), day-narrative design notes from the 2026-04-27 conversation, source inventory with reliability, open questions to confirm with Josh. |
